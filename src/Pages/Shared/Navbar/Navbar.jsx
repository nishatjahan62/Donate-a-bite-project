...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-[#F8F8F8] shadow-sm dark:bg-[#1E2939]  lg:px-20 font-poppins px-8">
      ...
      <div className="navbar-end">
        <div onClick={handleTheme} className="px-2 ">
          <label className="swap swap-rotate">
            ...
            <svg
              className="swap-on h-10 w-10 fill-current text-secondary"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
        ...
        {user ? (
          <div className="flex items-center gap-">
            ...
            <Button onClick={handleLogOut} label="SingOut"></Button>
          </div>
        ) : (
          <Link to="auth/Login">
